...
public class HoaDonDTO {
    ...
    public HoaDonDTO(String IDHoaDon, String IDKhachHang, String IDNhanVien, String IDGiamGia, Date NgayLapHoaDon, double TongTien, double TienGiamGia, int TrangThai) {
